    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("button.addToCart").click(function () {
                ...
                //location.href = "http://localhost:8080/28_BookCity/cartServlet?action=addItem&id=" + bookId;

                $.getJSON("http://localhost:8080/28_BookCity/cartServlet",
                "action=ajaAddItem&id=" + bookId,
                function (data) {
    ...
    <div id="book">
        ...
        <div style="text-align: center">
            ...
            <c:if test="${not empty sessionScope.cart.items}">
                ...
                <div>
                    您刚刚将<span style="color: red" id="cartLastName">《${sessionScope.get("lastName")}》</span>加入到了购物车中
                </div>
            </c:if>
        </div>
