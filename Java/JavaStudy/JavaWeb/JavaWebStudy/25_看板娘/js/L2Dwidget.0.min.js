...
webpackJsonpL2Dwidget([0], {
    76: function (t, e, i) {
        ...
        var r, o = i(38), n = i(80), s = i(77), a = i(78), _ = i(84), h = i(81), l = i(79), $ = i(39),
            u = (r = $, r && r.__esModule ? r : {default: r}), p = i(37);
        var c = null, f = void 0, g = !1, d = null, y = null, m = null, T = null, P = !1, S = .5;
        ...
        function v(t, e, i) {
            ...
            function n(t, e) {
                return 180 * Math.acos((i = {x: 0, y: 1}, r = function (t, e) {
            ...
            var s = n(r, o);
            e.x < t.x && (s = 360 - s);
            var a = 360 - n(i.left - t.x, -1 * (i.top - t.y)), _ = 360 - n(i.left - t.x, -1 * (i.top + i.height - t.y)),
                h = n(i.left + i.width - t.x, -1 * (i.top - t.y)),
                l = n(i.left + i.width - t.x, -1 * (i.top + i.height - t.y)), $ = o / r, u = {};
            if (s < h) {
                var p = i.top - t.y, c = p / $;
                u = {y: t.y + p, x: t.x + c}
            } else if (s < l) {
                var f = i.left + i.width - t.x, g = f * $;
                u = {y: t.y + g, x: t.x + f}
            } else if (s < _) {
                var d = i.top + i.height - t.y, y = d / $;
                u = {y: t.y + d, x: t.x + y}
            } else if (s < a) {
                var m = t.x - i.left, T = m * $;
                u = {y: t.y - T, x: t.x - m}
            } else {
                var P = i.top - t.y, S = P / $;
                u = {y: t.y + P, x: t.x + S}
        ...
        function L(t) {
            P = !0;
            var e = n.currCanvas.getBoundingClientRect(), i = w(t.clientX - e.left), r = D(t.clientY - e.top),
                o = v({x: e.left + e.width / 2, y: e.top + e.height * S}, {x: t.clientX, y: t.clientY}, e),
                s = A(o.x - e.left), a = I(o.y - e.top);
        ...
        e.theRealInit = function () {
            ...
            var t = n.currCanvas.getBoundingClientRect(), e = t.height / t.width, i = l.cDefine.VIEW_LOGICAL_LEFT,
                r = l.cDefine.VIEW_LOGICAL_RIGHT, $ = -e, P = e;
        ...
        (function (t) {
            ...
            r._$0s = 1, r._$4s = 2, r._$42 = 0, r._$62 = function (t, e) {
                ...
                if (0 != i) if (1 == t.length) {
                    u = t[0];
                    var s = 0 != this.getParamFloat(u), a = (p = e[0], this.getPartsOpacity(p)), _ = i / r;
                    ...
                    var u = t[$], p = e[$], c = 0 != this.getParamFloat(u);
            ...
            o.CHANNEL_COUNT = 4, o.RENDER_TEXTURE_USE_MIPMAP = !1, o.NOT_USED_FRAME = -100, o.prototype._$L7 = function () {
                ...
                for (var r = 0; r < e.length; r++) {
                    ...
                    if (null != o) {
                        ...
                        var a = e[r].getDrawDataID(), _ = t.getDrawDataIndex(a);
                ...
                if (i > 0) {
                    var n = e.gl.getParameter(e.gl.FRAMEBUFFER_BINDING), s = new Array(4);
                    ...
                    for (r = 0; r < this.clipContextList.length; r++) {
                        ...
                        var h = _.width / this.tmpBoundsOnModel.width, l = _.height / this.tmpBoundsOnModel.height;
                        ...
                        for (var c = o.clippingMaskDrawIndexList.length, f = 0; f < c; f++) {
                            var g = o.clippingMaskDrawIndexList[f], d = t.getDrawData(g), y = t._$C2(g);
                ...
                for (var e = 0; e < this.clipContextList.length; e++) {
                    var i = this.clipContextList[e], r = i.clipIDList.length;
                    if (r == t.length) {
                ...
                for (var i = t._$Ri.getModelImpl().getCanvasWidth(), r = t._$Ri.getModelImpl().getCanvasHeight(), o = i > r ? i : r, n = o, s = o, a = 0, _ = 0, h = e.clippedDrawContextList.length, l = 0; l < h; l++) {
                    var $ = e.clippedDrawContextList[l].drawDataIndex, u = t._$C2($);
                    if (u._$yo()) {
                ...
                var e = t / o.CHANNEL_COUNT, i = t % o.CHANNEL_COUNT;
                e = ~~e, i = ~~i;
            ...
            s._$JT = function (t, e, i) {
                var r = t / e, o = i / e, n = 1 - (1 - o) * (1 - o), s = 1 - (1 - o) * (1 - o),
                    a = 1 / 3 * (1 - o) * n + (o * (2 / 3) + 1 / 3 * (1 - o)) * (1 - n),
                    _ = (o + 2 / 3 * (1 - o)) * s + (o * (1 / 3) + 2 / 3 * (1 - o)) * (1 - s),
                    h = 1 - 3 * _ + 3 * a - 0, l = 3 * _ - 6 * a + 0, $ = 3 * a - 0;
                if (r <= 0) return 0;
                if (r >= 1) return 1;
                var u = r * r;
            ...
            u.prototype.setup = function (t, e, i) {
                ...
                var r, o, n = -Math.atan2(this.p1.y - this.p2.y, this.p1.x - this.p2.x), s = Math.cos(n),
                    a = Math.sin(n), _ = 9.8 * this.p2._$p, h = this._$Db * vt._$bS, l = _ * Math.cos(n - h);
                r = l * a, o = l * s;
                var $ = -this.p1.fx * a * a, u = -this.p1.fy * a * s, p = -this.p2.vx * this._$L2,
            ...
            f.prototype = new c, f.prototype._$oP = function (t, e) {
                var i = this.scale * t.getParamFloat(this._$wL), r = e.getPhysicsPoint1();
                switch (this._$tL) {
                    default:
                    case u.Src.SRC_TO_X:
            ...
            S._$Z2 = function (t, e, i, r) {
                var o = e._$Q2(t, i), n = t._$vs(), s = t._$Tr();
                if (e._$zr(n, s, o), o <= 0) return r[n[0]];
                if (1 == o) {
                    return (a = r[n[0]]) + ((_ = r[n[1]]) - a) * ($ = s[0]) | 0
                }
                if (2 == o) {
                    var a = r[n[0]], _ = r[n[1]], h = r[n[2]], l = r[n[3]], $ = s[0], u = s[1];
                    return (S = a + (_ - a) * $ | 0) + ((h + (l - h) * $ | 0) - S) * u | 0
                }
                if (3 == o) {
                    var p = r[n[0]], c = r[n[1]], f = r[n[2]], g = r[n[3]], d = r[n[4]], y = r[n[5]], m = r[n[6]],
                        T = r[n[7]], P = ($ = s[0], u = s[1], s[2]);
                    return (S = (a = p + (c - p) * $ | 0) + ((_ = f + (g - f) * $ | 0) - a) * u | 0) + (((h = d + (y - d) * $ | 0) + ((l = m + (T - m) * $ | 0) - h) * u | 0) - S) * P | 0
                }
                if (4 == o) {
                    var S, v = r[n[0]], L = r[n[1]], M = r[n[2]], E = r[n[3]], x = r[n[4]], A = r[n[5]], I = r[n[6]],
                        w = r[n[7]], D = r[n[8]], O = r[n[9]], b = r[n[10]], R = r[n[11]], F = r[n[12]], C = r[n[13]],
                        N = r[n[14]], B = r[n[15]], G = ($ = s[0], u = s[1], P = s[2], s[3]);
                ...
                if (2 == o) {
                    var a = r[n[0]], _ = r[n[1]], h = r[n[2]], l = r[n[3]], $ = s[0];
                    return (1 - (T = s[1])) * (a + (_ - a) * $) + T * (h + (l - h) * $)
                }
                if (3 == o) {
                    var u = r[n[0]], p = r[n[1]], c = r[n[2]], f = r[n[3]], g = r[n[4]], d = r[n[5]], y = r[n[6]],
                        m = r[n[7]], T = ($ = s[0], s[1]);
                    return (1 - (N = s[2])) * ((1 - T) * (u + (p - u) * $) + T * (c + (f - c) * $)) + N * ((1 - T) * (g + (d - g) * $) + T * (y + (m - y) * $))
                }
                if (4 == o) {
                    var P = r[n[0]], S = r[n[1]], v = r[n[2]], L = r[n[3]], M = r[n[4]], E = r[n[5]], x = r[n[6]],
                        A = r[n[7]], I = r[n[8]], w = r[n[9]], D = r[n[10]], O = r[n[11]], b = r[n[12]], R = r[n[13]],
                        F = r[n[14]], C = r[n[15]], N = ($ = s[0], T = s[1], s[2]), B = s[3];
                ...
                var _ = e._$Q2(t, i), h = t._$vs(), l = t._$Tr();
                e._$zr(h, l, _);
                var $ = 2 * r, u = s;
                if (_ <= 0) {
                    var p = o[h[0]];
                    ...
                    p = o[h[0]];
                    var f = o[h[1]], g = 1 - (m = l[0]);
                    for (c = 0; c < $;) n[u] = p[c] * g + f[c] * m, ++c, n[u + 1] = p[c] * g + f[c] * m, ++c, u += a
                } else if (2 == _) {
                    p = o[h[0]], f = o[h[1]];
                    var d = o[h[2]], y = o[h[3]], m = l[0], T = (k = 1 - (b = l[1])) * (g = 1 - m), P = k * m,
                        S = b * g, v = b * m;
                    for (c = 0; c < $;) n[u] = T * p[c] + P * f[c] + S * d[c] + v * y[c], ++c, n[u + 1] = T * p[c] + P * f[c] + S * d[c] + v * y[c], ++c, u += a
                } else if (3 == _) {
                    var L = o[h[0]], M = o[h[1]], E = o[h[2]], x = o[h[3]], I = o[h[4]], w = o[h[5]], D = o[h[6]],
                        O = o[h[7]], b = (m = l[0], l[1]), R = (V = 1 - (st = l[2])) * (k = 1 - b) * (g = 1 - m),
                        F = V * k * m, C = V * b * g, N = V * b * m, B = st * k * g, G = st * k * m, U = st * b * g,
                        Y = st * b * m;
                    ...
                    var k, V, X = o[h[0]], z = o[h[1]], H = o[h[2]], W = o[h[3]], j = o[h[4]], q = o[h[5]], J = o[h[6]],
                        Q = o[h[7]], Z = o[h[8]], K = o[h[9]], tt = o[h[10]], et = o[h[11]], it = o[h[12]],
                        rt = o[h[13]], ot = o[h[14]], nt = o[h[15]], st = (m = l[0], b = l[1], l[2]), at = l[3],
                        _t = 1 - at, ht = _t * (V = 1 - st) * (k = 1 - b) * (g = 1 - m), lt = _t * V * k * m,
                        $t = _t * V * b * g, ut = _t * V * b * m, pt = _t * st * k * g, ct = _t * st * k * m,
                        ft = _t * st * b * g, gt = _t * st * b * m, dt = at * V * k * g, yt = at * V * k * m,
                        mt = at * V * b * g, Tt = at * V * b * m, Pt = at * st * k * g, St = at * st * k * m,
                        vt = at * st * b * g, Lt = at * st * b * m;
            ...
            }, M.prototype._$Uo = function (t, e, i, r, o, n, s) {
            }, M.prototype._$Rs = function () {
                return -1
            }, M.prototype._$Ds = function (t) {
            }, M.prototype.setBaseColor = function (t, e, i, r) {
            ...
            w.startsWith = function (t, e, i) {
                ...
                var o = i, n = !1, s = !1, a = 0, _ = w.getChar(t, o);
                "-" == _ && (n = !0, o++);
                for (var h = !1; o < e; o++) {
            ...
            D.prototype._$zP = function () {
                ...
                for (var e = t, i = this._$Ob.length, r = 0; r < i; ++r) {
                    var o = this._$Ob[r], n = o._$N2(), s = e % o._$N2(), a = o._$d2()[s];
            ...
            O.prototype.identity = function () {
                ...
                var e = vt.fcos(t), i = vt._$9(t), r = this.m[4];
                ...
                var e = vt.fcos(t), i = vt._$9(t), r = this.m[0];
            ...
            R._$kS = -1, R._$pS = 0, R._$hb = 1, R.STATE_IDENTITY = 0, R._$gb = 1, R._$fo = 2, R._$go = 4, R.prototype.transform = function (t, e, i) {
                ...
                this._$IT(t);
                var e = t[0], i = t[2], r = t[1], o = t[3], n = Math.sqrt(e * e + r * r), s = e * o - i * r;
                ...
                var e = Math.cos(t[3]), i = Math.sin(t[3]);
            ...
            F.prototype = new s, F._$cs = "VISIBLE:", F._$ar = "LAYOUT:", F._$Co = 0, F._$D2 = [], F._$1T = 1, F.loadMotion = function (t) {
                ...
                for (var o = (e - r._$z2) * this._$D0 / 1e3, n = 0 | o, s = o - n, a = 0; a < this.motions.length; a++) {
                    var _ = this.motions[a], h = _._$I0.length, l = _._$4P;
                    if (_._$RP == N._$hs) {
                        var $ = _._$I0[n >= h ? h - 1 : n];
                        t.setParamFloat(l, $)
                    } else if (N._$ws <= _._$RP && _._$RP <= N._$Ys) ; else {
                        var u = t.getParamFloat(l), p = _._$I0[n >= h ? h - 1 : n],
            ...
            U._$HP = 0, U._$_0 = !0, U._$V2 = -1, U._$W0 = -1, U._$jr = !1, U._$ZS = !0, U._$tr = -1e6, U._$lr = 1e6, U._$is = 32, U._$e = !1, U.prototype.getDrawDataIndex = function (t) {
                ...
                if (t instanceof b) {
                    if (null == this._$Bo) {
                        ...
                        for (var e = this._$aS.length, i = 0; i < e; i++) {
                            var r = this._$aS[i], o = r.getDrawDataID();
                ...
                for (var t = this._$Ri.getModelImpl(), e = t._$Xr(), i = e.length, r = new Array, n = new Array, s = 0; s < i; ++s) {
                    ...
                    var u = a.getDrawData(), p = u.length;
                    for (l = 0; l < p; ++l) {
                        var c = u[l], f = c.init(this);
                ...
                var i = this._$3S.length, r = this._$aS.length, o = W._$or(), n = W._$Pr() - o + 1;
                ...
                for (var s = null, _ = 0; _ < i; ++_) {
                    var h = this._$3S[_], l = this._$db[_];
                    try {
            ...
            X.prototype = new M, X._$As = 32, X._$Gr = !1, X._$NT = null, X._$vS = null, X._$no = null, X._$9r = function (t) {
                ...
                if (!(n < .01)) {
                    var _ = this._$U2[t], h = n > .9 ? at.EXPAND_W : 0;
                ...
                var e = Math.max(2 * this._$sb.length, t + 1 + 10), i = new Int32Array(e);
            ...
            z.prototype = new x, z._$Xo = new Float32Array(2), z._$io = new Float32Array(2), z._$0o = new Float32Array(2), z._$Lo = new Float32Array(2), z._$To = new Float32Array(2), z._$Po = new Float32Array(2), z._$gT = new Array, z.prototype._$zP = function () {
                ...
                if (this._$GS._$Ur(t)) {
                    ...
                    if (this._$GS._$zr(n, s, o), o <= 0) {
                        ...
                        var l = this._$Y0[n[2]], $ = this._$Y0[n[3]], u = (h = s[0], s[1]),
                            p = a._$fL + (_._$fL - a._$fL) * h, c = l._$fL + ($._$fL - l._$fL) * h;
                        ...
                        var f = this._$Y0[n[0]], g = this._$Y0[n[1]], d = this._$Y0[n[2]], y = this._$Y0[n[3]],
                        ...
                        var E = this._$Y0[n[0]], x = this._$Y0[n[1]], A = this._$Y0[n[2]], I = this._$Y0[n[3]],
                            w = this._$Y0[n[4]], D = this._$Y0[n[5]], O = this._$Y0[n[6]], b = this._$Y0[n[7]],
                            R = this._$Y0[n[8]], F = this._$Y0[n[9]], C = this._$Y0[n[10]], N = this._$Y0[n[11]],
            ...
            J.loadMotion = function (t) {
                t instanceof ArrayBuffer && (t = new DataView(t));
                var e = new J, i = [0], r = t.byteLength;
                e._$yT = 0;
                for (var o = 0; o < r; ++o) {
                ...
                for (var o = (e - r._$z2) * this._$D0 / 1e3, n = 0 | o, s = o - n, a = 0; a < this.motions.length; a++) {
                    ...
                    if (_._$RP == N._$hs) {
                        ...
                        var u = t.getParamIndex(l), p = t.getModelContext(),
                            c = .4 * (p.getParamMax(u) - p.getParamMin(u)), f = p.getParamFloat(u),
                            g = _._$I0[n >= h ? h - 1 : n], d = _._$I0[n + 1 >= h ? h - 1 : n + 1],
            ...
            Z.prototype = new x, Z._$gT = new Array, Z.prototype._$zP = function () {
                ...
                var e = new K(this), i = (this._$o + 1) * (this._$A + 1);
                ...
                if (i._$hS(!0), this._$32()) {
                    var r = this.getTargetBaseDataID();
                    if (i._$8r == x._$ur && (i._$8r = t.getBaseDataIndex(r)), i._$8r < 0) at._$so && a._$li("_$L _$0P _$G :: %s", r), i._$hS(!1); else {
                        var o = t.getBaseData(i._$8r), n = t._$q2(i._$8r);
                        if (null != o && n._$yo()) {
                ...
                var a = e, _ = null != a._$hr ? a._$hr : a._$Cr;
                ...
                for (var h, l, $, u = r * n, p = 0, c = 0, f = 0, g = 0, d = 0, y = 0, m = !1, T = o; T < u; T += n) {
                    ...
                    if (v = e[T], S = (L = e[T + 1]) * _, (P = v * a) < 0 || S < 0 || a <= P || _ <= S) {
                        ...
                        if (-2 < v && v < 3 && -2 < L && L < 3) if (v <= 0) if (L <= 0) {
                            var w = s[2 * (0 + 0 * M)], D = s[2 * (0 + 0 * M) + 1], O = p - 2 * f, b = c - 2 * g,
                                R = p - 2 * d, F = c - 2 * y, C = p - 2 * f - 2 * d, N = c - 2 * g - 2 * y;
                            ...
                            (k = 0 | S) == _ && (k = _ - 1);
                            var B = .5 * (v - -2), G = S - k, U = k / _, Y = (k + 1) / _;
            ...
            ot.tr = new gt, ot._$50 = new gt, ot._$Ti = new Array(0, 0), ot._$Pi = new Array(0, 0), ot._$B = new Array(0, 0), ot.prototype._$lP = function (t, e, i, r) {
                ...
                try {
                    ...
                    for (var h = e.length, l = t.width, $ = t.height, u = this.context, p = this._$xP, c = this._$uP, f = this._$6r, g = this._$3r, d = ot.tr, y = ot._$Ti, m = ot._$Pi, P = ot._$B, S = 0; S < h; S += 3) {
                        u.save();
                        var v = e[S], L = e[S + 1], M = e[S + 2], E = p + f * i[2 * v], x = c + g * i[2 * v + 1],
                            A = p + f * i[2 * L], I = c + g * i[2 * L + 1], w = p + f * i[2 * M],
                            D = c + g * i[2 * M + 1];
                        s && (s._$PS(E, x, P), E = P[0], x = P[1], s._$PS(A, I, P), A = P[0], I = P[1], s._$PS(w, D, P), w = P[0], D = P[1]);
                        var O = l * r[2 * v], b = $ - $ * r[2 * v + 1], R = l * r[2 * L], F = $ - $ * r[2 * L + 1],
                            C = l * r[2 * M], N = $ - $ * r[2 * M + 1], B = Math.atan2(F - b, R - O),
                            G = Math.atan2(I - x, A - E), U = A - E, Y = I - x, k = Math.sqrt(U * U + Y * Y), V = R - O,
                            X = F - b, z = k / Math.sqrt(V * V + X * X);
                        T._$ni(C, N, O, b, R - O, F - b, -(F - b), R - O, y), T._$ni(w, D, E, x, A - E, I - x, -(I - x), A - E, m);
                        var H = (m[0] - y[0]) / y[1], W = Math.min(O, R, C), j = Math.max(O, R, C),
                            q = Math.min(b, F, N), J = Math.max(b, F, N), Q = Math.floor(W), Z = Math.floor(q),
                ...
                var l = s - o, $ = a - n, u = _ - o, p = h - n, c = l * p - $ * u > 0 ? i : -i, f = -$, g = l,
                    d = _ - s, y = h - a, m = -y, T = d, P = Math.sqrt(d * d + y * y), S = -p, v = u,
                    L = Math.sqrt(u * u + p * p), M = o - c * f / r, E = n - c * g / r, x = s - c * f / r,
                    A = a - c * g / r, I = s - c * m / P, w = a - c * T / P, D = _ - c * m / P, O = h - c * T / P,
                    b = o + c * S / L, R = n + c * v / L, F = _ + c * S / L, C = h + c * v / L, N = ot._$50;
            ...
            lt.prototype = new W, lt._$42 = 0, lt._$Os = 30, lt._$ms = 0, lt._$ns = 1, lt._$_s = 2, lt._$gT = new Array, lt.prototype._$_S = function (t) {
                ...
                var r = e, o = null != r._$hr ? r._$hr : r._$Cr;
                switch (B._$do) {
                    default:
                    case B._$Ms:
                ...
                var e = new $t(this), i = this._$d0 * B._$No, r = this._$32();
                ...
                switch (B._$do) {
                    ...
                    case B._$Qs:
                        for (o = this._$d0 - 1; o >= 0; --o) {
                            n = o << 1;
                            var s = o * B._$No, a = this._$Qi[n], _ = this._$Qi[n + 1];
                ...
                if (this != i._$GT() && console.log("### assert!! ### "), !i._$IS[0]) {
                    var r = i, o = this._$LP;
                    o < 0 && (o = 1);
                    var n = this.getOpacity(e, r) * i._$VS * i.baseOpacity, s = null != r._$hr ? r._$hr : r._$Cr;
            ...
            gt.prototype.setContext = function (t) {
                ...
                t || (t = new gt);
                var e = this.m, i = e[0], r = e[1], o = e[2], n = e[3], s = e[4], a = e[5], _ = e[6], h = e[7],
                    l = e[8], $ = i * s * l + r * a * _ + o * n * h - i * a * h - o * s * _ - r * n * l;
                if (0 == $) return null;
                var u = 1 / $;
                ...
                var i = this.m, r = i[0] + i[3] * e, o = i[1] + i[4] * e, n = i[2] + i[5] * e;
                i[3] = i[0] * t + i[3], i[4] = i[1] * t + i[4], i[5] = i[2] * t + i[5], i[0] = r, i[1] = o, i[2] = n
            }, gt.prototype.rotate = function (t) {
                var e = this.m, i = Math.cos(t), r = Math.sin(t), o = e[0] * i + e[3] * r, n = e[1] * i + e[4] * r,
                    s = e[2] * i + e[5] * r;
                e[3] = -e[0] * r + e[3] * i, e[4] = -e[1] * r + e[4] * i, e[5] = -e[2] * r + e[5] * i, e[0] = o, e[1] = n, e[2] = s
            }, gt.prototype.concatenate = function (t) {
                var e = this.m, i = t.m, r = e[0] * i[0] + e[3] * i[1] + e[6] * i[2],
                    o = e[1] * i[0] + e[4] * i[1] + e[7] * i[2], n = e[2] * i[0] + e[5] * i[1] + e[8] * i[2],
                    s = e[0] * i[3] + e[3] * i[4] + e[6] * i[5], a = e[1] * i[3] + e[4] * i[4] + e[7] * i[5],
                    _ = e[2] * i[3] + e[5] * i[4] + e[8] * i[5], h = e[0] * i[6] + e[3] * i[7] + e[6] * i[8],
                    l = e[1] * i[6] + e[4] * i[7] + e[7] * i[8], $ = e[2] * i[6] + e[5] * i[7] + e[8] * i[8];
            ...
            yt.prototype = new M, yt._$9r = function (t) {
                ...
                if (!(n < .01 && null == this.clipBufPre_clipContextMask)) {
                    ...
                    if (null != this.clipBufPre_clipContextMask) {
                        ...
                        var p = this.getClipBufPre_clipContextMask().layoutChannelNo, c = this.getChannelFlagAsColor(p);
            ...
            yt.prototype._$Rs = function () {
                ...
                var i = this.gl, r = e, o = i.createShader(t);
                ...
                var t = this.gl, e = at.clippingMaskBufferSize, i = t.createFramebuffer();
            ...
            vt._$2S = Math.PI / 180, vt._$bS = Math.PI / 180, vt._$wS = 180 / Math.PI, vt._$NS = 180 / Math.PI, vt.PI_F = Math.PI, vt._$kT = [0, .012368, .024734, .037097, .049454, .061803, .074143, .086471, .098786, .111087, .12337, .135634, .147877, .160098, .172295, .184465, .196606, .208718, .220798, .232844, .244854, .256827, .268761, .280654, .292503, .304308, .316066, .327776, .339436, .351044, .362598, .374097, .385538, .396921, .408243, .419502, .430697, .441826, .452888, .463881, .474802, .485651, .496425, .507124, .517745, .528287, .538748, .549126, .559421, .56963, .579752, .589785, .599728, .609579, .619337, .629, .638567, .648036, .657406, .666676, .675843, .684908, .693867, .70272, .711466, .720103, .72863, .737045, .745348, .753536, .76161, .769566, .777405, .785125, .792725, .800204, .807561, .814793, .821901, .828884, .835739, .842467, .849066, .855535, .861873, .868079, .874153, .880093, .885898, .891567, .897101, .902497, .907754, .912873, .917853, .922692, .92739, .931946, .936359, .940629, .944755, .948737, .952574, .956265, .959809, .963207, .966457, .96956, .972514, .97532, .977976, .980482, .982839, .985045, .987101, .989006, .990759, .992361, .993811, .995109, .996254, .997248, .998088, .998776, .999312, .999694, .999924, 1], vt._$92 = function (t, e) {
                var i = Math.atan2(t[1], t[0]), r = Math.atan2(e[1], e[0]);
                return vt._$tS(i, r)
            ...
            Mt._$W2 = 0, Mt.SYSTEM_INFO = null, Mt.USER_AGENT = navigator.userAgent, Mt.isIPhone = function () {
                ...
                var i, r = Mt.SYSTEM_INFO = {userAgent: t};
        ...
        o.prototype.getModelMatrix = function () {
            ...
            var u = this.modelMatrix.invertTransformX(e), p = this.modelMatrix.invertTransformY(i);
        ...
        s.prototype = new r.AMotion, s.EXPRESSION_DEFAULT = "DEFAULT", s.TYPE_SET = 0, s.TYPE_ADD = 1, s.TYPE_MULT = 2, s.loadJson = function (t) {
            var e = new s, i = y.getPlatformManager().jsonParseFromBytes(t);
            ...
            var r = i.params, o = r.length;
            e.paramList = [];
            for (var n = 0; n < o; n++) {
                var _ = r[n], h = _.id.toString(), l = parseFloat(_.val), $ = s.TYPE_ADD,
        ...
        $.prototype = new l, $.prototype.setPosition = function (t, e) {
            ...
            var i = this.width * this.getScaleX(), r = this.height * this.getScaleY();
            ...
            var e = t / this.height, i = -e;
            this.scale(e, i)
        }, $.prototype.setWidth = function (t) {
            var e = t / this.width, i = -e;
            this.scale(e, i)
        };
        ...
        p.load = function (t) {
            for (var e = new p, i = y.getPlatformManager().jsonParseFromBytes(t).physics_hair, o = i.length, n = 0; n < o; n++) {
                var s = i[n], a = new r.PhysicsHair, _ = s.setup, h = parseFloat(_.length), l = parseFloat(_.regist),
                    $ = parseFloat(_.mass);
                a.setup(h, l, $);
                for (var u = s.src, c = u.length, f = 0; f < c; f++) {
                    var g = u[f], d = g.id, m = r.PhysicsHair.Src.SRC_TO_X;
        ...
        c.load = function (t) {
            ...
            if (null != t) {
                ...
                var e = r.UtSystem.getUserTimeMSec(), i = 0 == this.lastTime ? 0 : (e - this.lastTime) / 1e3;
            ...
            if (null != t) for (var e = 0; e < this.partsGroups.length; e++) for (var i = this.partsGroups[e], r = 0; r < i.length; r++) {
                i[r].initIndex(t);
                var o = i[r].partsIndex, n = i[r].paramIndex;
                if (!(o < 0)) {
            ...
            for (var r = -1, o = 1, n = 0; n < e.length; n++) {
                var s = e[n].partsIndex, a = e[n].paramIndex;
        ...
        g.FRAME_RATE = 60, g.prototype.setPoint = function (t, e) {
            ...
            if (0 != this.lastTimeSec) {
                var e = r.UtSystem.getUserTimeMSec(), i = (e - this.lastTimeSec) * g.FRAME_RATE / 1e3;
                this.lastTimeSec = e;
                var o = i * t / (.15 * g.FRAME_RATE), n = this.faceTargetX - this.faceX,
                    s = this.faceTargetY - this.faceY;
                if (!(Math.abs(n) <= this.EPSILON && Math.abs(s) <= this.EPSILON)) {
                    var a = Math.sqrt(n * n + s * s), _ = t * s / a, h = t * n / a - this.faceVX, l = _ - this.faceVY,
                        $ = Math.sqrt(h * h + l * l);
        ...
        var r = i(38), o = i(37), n = i(82), s = void 0, a = void 0;
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0}), e.MatrixStack = r;
        ...
        var r = i(78), o = i(85), n = i(86), s = i(79);
        ...
        n.prototype.loadBytes = function (t, e) {
            ...
            n.crossOrigin = "Anonymous", n.src = i, n.onload = onload, n.onerror = onerror, n.onload = function () {
                var i = r.currWebGL, s = i.createTexture();
        ...
        var r = i(78), o = i(87), n = i(81), s = i(79), a = i(77);
        ...
        _.prototype = new r.L2DBaseModel, _.prototype.load = function (t, e, i) {
            ...
            var i = this.modelSetting.getMotionNum(t), r = parseInt(Math.random() * i);
            ...
            if (r.setFadeIn(this.modelSetting.getMotionFadeIn(t, e)), r.setFadeOut(this.modelSetting.getMotionFadeOut(t, e)), s.cDefine.DEBUG_LOG && console.log("Start motion : " + o), null == this.modelSetting.getMotionSound(t, e)) this.mainMotionManager.startMotionPrio(r, i); else {
                var n = this.modelSetting.getMotionSound(t, e), a = document.createElement("audio");
