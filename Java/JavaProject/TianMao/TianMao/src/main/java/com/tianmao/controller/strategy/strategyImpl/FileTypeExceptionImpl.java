...
/**
 * Created by LiLin on 2022/05/23/13:31
 */
public class FileTypeExceptionImpl extends BaseException implements ExceptionHandler {
    @Override
    public JsonResult<Void> run(Throwable e) {
        return getResult(8003, "文件类型错误", e);
    }

    @Override
    public void afterPropertiesSet() throws Exception {
        ExceptionFactory.registerException("FileTypeException", this);
    }
}
